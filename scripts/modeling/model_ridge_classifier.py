...
default_model = RidgeClassifier(random_state=42, class_weight="balanced")
default_model.fit(X_train, y_train)
y_pred_default = default_model.predict(X_test)
print("Evaluation - RidgeClassifier (Default):")
print(classification_report(y_test, y_pred_default, target_names=["poisonous", "edible"]))
joblib.dump(default_model, "models/ridge_classifier_default.pkl")
...
print("Evaluation - RidgeClassifier (Tuned):")
print(classification_report(y_test, y_pred_tuned, target_names=["poisonous", "edible"]))
joblib.dump(tuned_model, "models/ridge_classifier_tuned.pkl")